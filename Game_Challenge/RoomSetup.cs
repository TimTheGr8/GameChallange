...
namespace Game_Challenge
{
    public class RoomSetup
    {
        public static void SetupRooms(Room[] _rooms)
        {
            ...
            //Dining Room
            _rooms[4] = new Room(4, "north", "south", "east", "west", "that the clinking sound has gotten much louder, joined by laughter and conversations by people eating at a table. You also hear music and humming coming from the east.", "that whatever was cooked here, presumably, came from the south. You also catch whiffs of the women's perfumes and the men's cologne.", "Upon entering, you realize that you're surrounded by people much larger than you. Thankfully they're preoccupied with whatever heavenly smells are on the table. To the north you see an archway with paintings hung up.");

            //Hallway
            _rooms[5] = new Room(5, "north", "south", "east", "the raucous laughter from the dining room to the east.", "more tasty scents wafting to you from the south through this hallway. Yum.", "You are in a large hallway, adorned with hardwood floors and a running floor rug. Not very much space to hide. To the north you can see bright lights. ");
