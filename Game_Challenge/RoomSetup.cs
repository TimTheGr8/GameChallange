...
namespace Game_Challenge
{
    public class RoomSetup
    {
        public static void SetupRooms(Room[] _rooms)
        {
            ...
            //Parlor area?
            _rooms[6] = new Room(6, "north", "south", "west", "so much noise that it's hard to focus on one single piece. You hear laughing and conversations, and some snappy jazz being played from a large machine to the east. You could probably squeeze behind that....", "You smell sweat and perfumes and colognes. Hard to pinpoint anything really.", "Upon arrival you have to hide in the corner to avoid beign stepped on! Theres a lot of people here dancing and having fun. To the west you can see a large opening leading to the dining room, where people are seated and eating. To the north you can see a door cracked open slightly. Perhaps this could be a nice place away from so many large dangers....");
